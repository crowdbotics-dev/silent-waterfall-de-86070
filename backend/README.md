...
## Project Structure
    ...
    ├── silent_waterfall_de_86070  # Django project configurations
...
1. Clone this repo and `cd silent_waterfall_de_86070`
...
2. Clone this repo and `cd silent_waterfall_de_86070`
